...
{
public:
	UnionFind(size_t size) : nodes_(size) { for (size_t i = 0; i < size; ++i) {nodes_[i] = i;} }
...
{
	auto weightSorter = [] (const Edge& a, const Edge& b) { return a.weight < b.weight; };
